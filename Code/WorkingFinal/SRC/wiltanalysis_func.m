function [ angledata ] = wiltanalysis_func(wiltdata)
...
img_array = wiltdata.img_array;
rect_array = wiltdata.rect_array;
initialframe = wiltdata.initialframe_num;
finalframe = wiltdata.finalframe_num;
initiallevel = wiltdata.initialthreshold;
finallevel = wiltdata.finalthreshold;
sharpenradius = wiltdata.sharpenradius;
rgb_channel = wiltdata.rgb_channel;
invert_TF = wiltdata.invert_TF;
x = wiltdata.stalk_x;
y = wiltdata.stalk_y;
w = wiltdata.img_cropwidth;
h = wiltdata.img_cropheight;
