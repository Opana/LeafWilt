...
[handles.initialframe, handles.stalk_x, handles.stalk_y] = initialcrop_func(round(handles.initialframe_num), handles.img_array, handles.img_cropwidth, handles.img_cropheight);
axes(handles.axes1);
imshow(handles.initialframe);

[img_ymax,img_xmax,~] = size(handles.img_array{round(handles.initialframe_num)});
