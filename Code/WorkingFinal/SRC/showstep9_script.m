...
handles.initialframe_num = handles.initialframe_array(1);
handles.finalframe_num = handles.finalframe_array(1);
framecount = round(handles.initialframe_num):30:round(handles.finalframe_num);
