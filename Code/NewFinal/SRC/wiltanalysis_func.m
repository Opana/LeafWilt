function [ angledata ] = wiltanalysis_func(plant_obj)
...
img_array = plant_obj.img_array;
rect_array = plant_obj.rect_array;
initialframe = plant_obj.initialframe_num;
finalframe = plant_obj.finalframe_num;
initiallevel = plant_obj.initialthreshold;
finallevel = plant_obj.finalthreshold;
sharpenradius = plant_obj.sharpenradius;
rgb_channel = plant_obj.rgb_channel;
invert_TF = plant_obj.invert_TF;
x = plant_obj.stalk_x;
y = plant_obj.stalk_y;
w = plant_obj.img_cropwidth;
h = plant_obj.img_cropheight;
